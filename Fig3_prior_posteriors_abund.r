...
dev.copy(pdf,"/home/brian/Documents/Isotopes/mantis_shrimp_diet/Fig3_prior_posteriors_abund_color.pdf")
dev.off()
...
coral.prior.plot <- coral.prior.plot + theme(legend.position="none")
p3 <- grid.arrange(arrangeGrob(grass.prior.plot, coral.prior.plot, post.grass.plot, post.coral.plot,ncol=2,nrow=2), mylegend,ncol=1,nrow=2,heights=c(6.3,0.7))
dev.copy(pdf,"/home/brian/Documents/Isotopes/mantis_shrimp_diet/Fig3_prior_posteriors_abund_bw.pdf")
dev.off()
