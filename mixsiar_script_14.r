...
# Mantis shrimp diet analysis #14
#  prior: prey abundance (coral)
#  data:  coral mantis, coral sources
#  error: MixSIR
#  source data from coral
...
source <- load_source_data(filename="mantis_source_coral.csv", source_factors=NULL, conc_dep=TRUE, data_type="means", mix)    
...
alpha.abund <- c((25.88+14.97),0.001,16.2,(14.45+4.92),4.22,19.37)*6/100
