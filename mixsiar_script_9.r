...
# Mantis shrimp diet analysis #9
#  prior: hard-shelled prey 4x more likely
#  model: Habitat + source(Habitat)
...
folder <- "/9_habitat_sourcebyhab_indRE"
...
# run <- list(chainLength=1000000, burn=700000, thin=100, chains=3, calcDIC=TRUE)
